...
if ($_GET["dependencia_busqOri"])
    $dependencia_busqOri = $_GET["dependencia_busqOri"];
...
if (!$dependencia_busqOri)
    $dependencia_busqOri = $dependencia;
...
//</script>-->
    ...
    <table><tr><TD>AQUI ESTA LA TABLA</TD></tr></table>
                        ...
                        <td class="listado2">
                            <select name=dependencia_busq  class="select"  onChange="formulario.submit();">
						      ...
						      where $whereDepSelect ";
                                ...
                                if ($usua_perm_estadistica = 19) {
                                    // $isqlus = "select a.DEPE_CODI,a.DEPE_NOMB,a.DEPE_CODI_PADRE from DEPENDENCIA a WHERE DEPE_CODI IN (100, 200, 300, 400,110,120,130,140)  ORDER BY a.DEPE_NOMB";

                                    $isqlus = "select a.DEPE_CODI,a.DEPE_NOMB,a.DEPE_CODI_PADRE from DEPENDENCIA a where a.depe_codi not in (999,901,902,903) ORDER BY a.DEPE_NOMB";
                                }
  ...
  <?php
                    if ($tipoEstadistica == 18) {
					   ...
					   order by u.USUA_NOMB";
                        ...
                        $tipoEstadistica==12 or $tipoEstadistica==17  or $tipoEstadistica==18 or $tipoEstadistica==19)
                        {
                        ?>
                        <tr>
...
//
                if (isset($generarOrfeo) && $tipoEstadistica == 12 && $tipoEstadistica == 19) {
                    global $orderby;
